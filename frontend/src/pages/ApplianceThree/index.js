...
class ApplianceThree extends React.Component {
      ...
      <Row flexDirection='column' alignItems={'flex-start'} style={{height: '100vh'}}>
        ...
        <Row justifyContent='flex-start' flexDirection='column' style={{flexGrow: 1}}>
          <div style={{paddingBottom: '100px'}}>
            <Row pad={[64, 0, 16, 0]}>
              <Col xs={12}>
                <Text size={34} weight='medium'>Is your Water Heater gas or electric?</Text>
              </Col>
            </Row>
...
ApplianceThree.propTypes = {

};

export default withRouter(ApplianceThree);