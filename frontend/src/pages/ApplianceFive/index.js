...
class ApplianceFour extends React.Component {
      ...
      <Row flexDirection='column' alignItems={'flex-start'} style={{height: '100vh'}}>
        ...
        <Row justifyContent='flex-start' flexDirection='column' style={{flexGrow: 1}}>
          <div style={{paddingBottom: '100px'}}>
            <Row pad={[64, 0, 16, 0]}>
              <Col xs={12}>
                <Text size={34} weight='medium'>Is your <Text inline size={34} weight='medium' color='#21C4CC'>Dryer</Text> gas or electric?</Text>
              </Col>
            </Row>
...
ApplianceFour.propTypes = {

};

export default withRouter(ApplianceFour);